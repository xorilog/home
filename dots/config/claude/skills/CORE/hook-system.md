...
**Location:** `/Users/xophe/src/home/tools/claude-hooks/`
**Configuration:** `/Users/xophe/.config/claude/settings.json`
...
```
/Users/xophe/src/home/tools/claude-hooks/
├── cmd/
...
To configure these events, add them to `/Users/xophe/.config/claude/settings.json` in the `"hooks"` section. You would need to create corresponding Go implementations in the `claude-hooks` project.
...
### Location
**File:** `/Users/xophe/.config/claude/settings.json`
**Section:** `"hooks": { ... }`
...
```bash
cd /Users/xophe/src/home/tools/claude-hooks
...
Edit `/Users/xophe/.config/claude/settings.json` to enable hooks (should already be configured):
...
Create new command in `/Users/xophe/src/home/tools/claude-hooks/cmd/`:
...
- **Hook Source Code:** `/Users/xophe/src/home/tools/claude-hooks/`
- **Nix Package:** `/Users/xophe/src/home/tools/claude-hooks/default.nix`
- **Configuration:** `/Users/xophe/.config/claude/settings.json`
...
KEY FILES:
/Users/xophe/.config/claude/settings.json        Hook configuration
/Users/xophe/src/home/tools/claude-hooks/        Hook source code
